...
SKIN.PrintName		= "ModernUI"
SKIN.Author		= "Jaymate"
SKIN.DermaVersion	= 1
SKIN.GwenTexture	= Material( "gwenskin/modernui_dark.png" )
...
SKIN.fontCategoryHeader			= "DermaDefault"
...
derma.DefineSkin( "mui_dark", "XD LMAOOO", SKIN )
