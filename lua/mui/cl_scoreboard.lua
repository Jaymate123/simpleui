...
local PLAYER_LINE = {
	...
	Paint = function( self, w, h )
		...
		if ( !self.Player:Alive() ) then
			draw.RoundedBox( 8, 0, 0, w, h, Color( 230, 200, 200, 255 ) )
			return
		end

		if ( self.Player:IsAdmin() ) then
			draw.RoundedBox( 8, 0, 0, w, h, Color( 230, 255, 2, 255 ) )
			return
		end

		draw.RoundedBox( 8, 0, 0, w, h, Color( 230, 230, 20, 255 ) )
